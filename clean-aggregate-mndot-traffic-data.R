...
# hist(hourlydat_sensor[,num_lanes_with_data-r_node_lanes], 
#      breaks = 2*max(abs(hourlydat_sensor[,num_lanes_with_data-r_node_lanes])))
...
# hist(hourlydat_sensor$num_sensors_this_year - hourlydat_sensor$num_lanes_with_data)
...
hourlydat_node <- hourlydat[,lapply(.SD, sum), 
                       .SDcols = 'volume.sum',
